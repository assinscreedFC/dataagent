...
**Plans**: 3 plans (Complete ✓ 2026-06-13)
  - [x] 01-01-PLAN.md — Fondations : config Gemini + AgentState (8 champs, db UntrackedValue) + factory LLM
  - [x] 01-02-PLAN.md — Nodes : planner (Flash) + sql_tool minimal + synthesizer + introspection schema
...
**Plans**: 2 plans
  - [x] 03-01-PLAN.md — stats_tool : corrélation Pearson + détection anomalies z-score (Polars) + stats_tool_node
  - [x] 03-02-PLAN.md — viz_tool : figure plotly -> PNG déterministe (kaleido) dans reports/ + viz_tool_node, png_path dans findings
**UI hint**: yes
...
**Plans**: 2 plans
  ...
  - [x] 04-02-PLAN.md — Graphe branché (add_conditional_edges + path_map router & critic) + tests boucle/HARD CAP/multi-source
...
| 6. Eval, API & Demo | 1/3 | In Progress|  |
